...
This project is indexed by GitNexus as **swift-ios-skills** (8284 symbols, 8425 relationships, 0 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
